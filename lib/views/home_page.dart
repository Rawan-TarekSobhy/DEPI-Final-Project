...
class HomePage extends GetView<HomeController> {
            ...
            child: ClipRRect(
              ...
              child: BottomNavigationBar(
                ...
                items: const [
                  ...
                  BottomNavigationBarItem(icon: Icon(Icons.medication_rounded),
                      label: 'medications'),
                  BottomNavigationBarItem(
  ...
  Widget _homeTab(BuildContext context, double h, double w) {
    ...
    return SafeArea(
      child: SingleChildScrollView(
        child: Column(
          children: [
            _buildHeader(h, w, controller, context),
                      ...
                      Expanded(
                        child: _quickActionButton(
                          ...
                          const Color(0xFFFF7043),
                            ...
                            final connected = await connectivityService
                                .connected();
                            if (!connected) {
                              Get.snackbar(
                                'No internet',
            ...
            Padding(
              ...
              child: Obx(() {
                ...
                return Column(
                  children: List.generate(controller.todaysRecords.length,
                          (index) {
                        final IntakeRecord record = controller
                            .todaysRecords[index];
  ...
  void _showIntakeDialog(BuildContext context, HomeController controller,
      IntakeRecord record, Medication med) {
    final time = controller.formatTime(record.scheduledAt);
    showDialog(
      context: context,
      ...
      builder: (ctx) {
        ...
        return Center(
          child: ConstrainedBox(
            constraints: BoxConstraints(maxWidth: w * 0.9, maxHeight: MediaQuery
                .of(ctx)
                .size
                .height * 0.85),
            child: Material(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Container(
                      ...
                      height: 64,
                      decoration: BoxDecoration(
                          shape: BoxShape.circle, color: theme.primaryColor.withOpacity(0.1)),
                      child: Icon(
                          Icons.access_time, color: theme.primaryColor,
                          size: 30),
                    ),
                    const SizedBox(height: 16),
                    Text(
  ...
  Widget _buildHeader(double h, double w, HomeController controller, BuildContext context) {
    final theme = Theme.of(context);
