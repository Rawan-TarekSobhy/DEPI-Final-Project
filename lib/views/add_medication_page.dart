            ...
            child: Container(
              ...
              child: Row(
                ...
                children: [
                  ...
                  Icon(Icons.add_alarm, color: Get.theme.primaryColor, size: 22),
                ],
              ),
            ),
          ),
              ...
              return Container(
                ...
                child: Center(
                  child: Text(
                    ...
                    style: TextStyle(color: Get.theme.textTheme.bodyMedium!.color, fontSize: 13),
                  ),
                ),
              );
            }
    ...
    return Column(
      ...
      children: [
        ...
        TextFormField(
          ...
          maxLines: maxLines,
          style: TextStyle(fontSize: 14, color: Get.theme.textTheme.bodyLarge!.color),
          decoration: InputDecoration(
            hintText: hint,
            hintStyle: TextStyle(color: Get.theme.textTheme.bodyMedium!.color!.withOpacity(0.5), fontSize: 14),
            filled: true,
            ...
            enabledBorder: OutlineInputBorder(
              borderRadius: BorderRadius.circular(10),
              borderSide: BorderSide(color: Get.theme.textTheme.bodyMedium!.color!.withOpacity(0.2), width: 1),
            ),
    ...
    return Column(
      ...
      children: [
        ...
        Obx(
            ...
            hint: Text(
              'Select frequency',
              style: TextStyle(color: Get.theme.textTheme.bodyMedium!.color!.withOpacity(0.6), fontSize: 14),
            ),
            isExpanded: true,
            icon: Icon(
