...
class _$MedicationsDao extends MedicationsDao {
  _$MedicationsDao(
    ...
    this.changeListener,
        ...
        _medicationDeletionAdapter = DeletionAdapter(
            database,
            'medications',
            ['medId'],
            (Medication item) => <String, Object?>{
  ...
  final DeletionAdapter<Medication> _medicationDeletionAdapter;
  ...
  Future<void> insertMedication(Medication medication) async {
    await _medicationInsertionAdapter.insert(
        medication, OnConflictStrategy.replace);
  }

  @override
  Future<void> updateMedication(Medication med) async {
    await _medicationUpdateAdapter.update(med, OnConflictStrategy.abort);
  }

  @override
  Future<void> deleteMedication(Medication med) async {
    await _medicationDeletionAdapter.delete(med);
  }
}
